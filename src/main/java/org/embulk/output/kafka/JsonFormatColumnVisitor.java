...
public class JsonFormatColumnVisitor extends KafkaOutputColumnVisitor<ObjectNode> {
  ...
  JsonFormatColumnVisitor(
      KafkaOutputPlugin.PluginTask task, PageReader pageReader, ObjectMapper objectMapper) {
  ...
  public void timestampColumn(Column column) {
    ...
    jsonNode.put(
        column.getName(), timestampFormatter.format(pageReader.getTimestamp(column).getInstant()));
  }
